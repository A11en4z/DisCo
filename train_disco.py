...
class Trainer:
    ...
    def log_validation(self, step):
        ...
        for idx, batch in enumerate(pbar):
            ...
            object_embeddings, meta_data = self.object_fusion_tokenizer(layout_preds, semantics_embs.squeeze(0), obj_to_img)
            ...
            # 将验证图片保存到 output_dir/validation/step_<step>，仅主进程写入
            if self.accelerator.is_main_process:
